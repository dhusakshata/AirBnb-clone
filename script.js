  ...
  searchButton.addEventListener("click", () => {
    ...
    async function fetchapi() {
      ...
      const options = {
        ...
        headers: {
          "X-RapidAPI-Key":
            "729d57dc9fmshceda502192416bcp12f31bjsndbe92fa785aa",
    ...
    async function createListingCard(listing) {
      ...
      //   fetch(
      //     `http://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=${userLocation.lat},${userLocation.lng}&destinations=${listingLocation}&key=apikey`
      //   )
